...
class CustomFunctionsDashboard extends React.Component<ICustomFunctionsDashboardProps, ICustomFunctionsDashboardState> {
  constructor(props) {
    super(props);
  ...
  toggleMetadata = () => {
    this.setState({metadata: {isVisible: !this.state.metadata.isVisible, data: this.state.metadata.data}});
  }
