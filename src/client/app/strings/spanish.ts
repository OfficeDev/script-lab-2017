...
export function getSpanishStrings(): ClientStringsPerLanguage {
  ...
  return {
    ...
    import: 'Importar',
    snippetImportExistingButtonLabel: getEnglishSubstitutesForNotYetTranslated()
      .snippetImportExistingButtonLabel,
    overwriteExistingButtonLabel: getEnglishSubstitutesForNotYetTranslated()
      .overwriteExistingButtonLabel,
    createNewCopyButtonLabel: getEnglishSubstitutesForNotYetTranslated()
      .createNewCopyButtonLabel,
    editorTriggerSuggestContextMenuLabel: 'Sugerir código',

    failedToLoadCodeSnippet: getEnglishSubstitutesForNotYetTranslated()
      .failedToLoadCodeSnippet,

    snippetGistIdDuplicationError: getEnglishSubstitutesForNotYetTranslated()
    ...
    snippetNoOfficeMessage:
      'Sólo se pueden ejecutar fragmentos de código dentro de un Add-in para Office.  Adquiere gratuitamente Script Lab hoy en https://aka.ms/getscriptlab.',
    ...
    snippetExportNotSupported:
      'La exportacion de fragmentos de código no esta soportada en esta versión de Office. Dicha funcionalidad esta soportada sólo en las plataformas Windows y Office Online.',
    ...
    changeEnvironmentConfirm:
      'Está por cambiar el ambiente de Script Lab y no tendrá acceso a los fragmentos de código guardados de manera local hasta que regrese al ambiente. ¿Está seguro de proceder?',
    ...
    sharePublicSnippetConfirm:
      '¿Estás seguro de compartir nuevamente este fragmento como un nuevo gist público?',
    sharePrivateSnippetConfirm:
      '¿Estás seguro de compartir nuevamente este fragmento como un nuevo gist secreto?',
    ...
    noSnippetsMessage:
      'No tienes fragmentos de código locales. Puedes ya sea crear uno, escojer un ejemplo o importar alguno.',
    ...
    sharedGistsSignIn:
      'Inicia una sesión en Github para acceder a los fragmentos de código que has compartido ahí.',
    ...
    localStorageWarning:
      `Los fragmentos de código creados localmente serán borrados si se limpia el cache del navegador. ` +
    ...
    Runner: {
      snippetNoLongerExists:
        'El fragmento de código ya no existe. Recarga esta página or regresa a la anterior.',
    ...
    HtmlPageStrings: {
      ...
      toGetStartedCreateOrImportSnippet:
        'Para empezar, crea o importa un fragmento de código seleccionando el botton "Codigo".',
      ...
      tutorialDescription:
        'Este archivo de Excel te muestra como utilizar Script Lab en sencillos pasos:',
      download: 'Descargar',
