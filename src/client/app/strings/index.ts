...
export function getDisplayLanguage() {
    let rawDisplayLanguage = getRawDisplayLanguage();
    if (rawDisplayLanguage) {
        rawDisplayLanguage = rawDisplayLanguage.toLowerCase();
    ...
    return (rawDisplayLanguage || 'en').substr(0, 2);
}
