...
export function getGermanStrings(): ClientStringsPerLanguage {
  ...
  return {
    ...
    snippetDeleteAllError:
      'Die lokal gespeicherten Schnipsel konnten nicht gelöscht werden.',
    snippetLoadAllError:
    ...
    snippetNoOfficeMessage:
      'Office Code-Schnipsel können nur innerhalb eines Office-Add-Ins ausgeführt werden. Erweitern Sie Office heute noch um das kostenlose Add-In Script Lab, welches Sie unter https://aka.ms/getscriptlab abrufen können.',
    ...
    gistUpdateUrlIsSameAsBefore:
      'Die URL Ihres aktualisierten GitHub-Gists ist dieselbe wie zuvor:',
    ...
    snippetCopiedFailed:
      'Das Schnipsel konnte nicht in die Zwischenablage kopiert werden.',

    snippetExportFailed: 'Das Schnipsel konnte nicht exportiert werden.',
    snippetExportNotSupported:
      'Das Exportieren von Schnipseln wird in dieser Office-Version noch nicht unterstützt. Unterstützte Plattformen sind zurzeit Windows und Office-Online.',
    ...
    changeEnvironmentConfirm:
      'Sie sind dabei, zu einer anderen Umgebung von Script Lab zu wechseln und verlieren dadurch den Zugriff auf Ihre gespeicherten Schnipsel bis Sie wieder zu dieser Umgebung zurückkehren. Möchten Sie fortfahren?',
    showExperimentationFlags: 'Experimentelle Flags anzeigen',
    invalidExperimentationFlags:
      'Bei den experimentellen Flags muss es sich um Daten in einem gültigen JSON-Format handeln.',
    ...
    sharePublicSnippetConfirm:
      'Sind Sie sicher, dass dieses Schnipsel erneut in einem neuen öffentlichen GitHub-Gist geteilt werden soll?',
    sharePrivateSnippetConfirm:
      'Sind Sie sicher, dass dieses Schnipsel erneut in einem neuen geheimen GitHub-Gist geteilt werden soll?',
    ...
    noSnippetsMessage:
      'Es wurden auf diesem Computer noch keine Schnipsel gespeichert. Sie können ein neues Schnipsel erstellen, ein Schnipsel aus den Beispielen auswählen oder ein Schnipsel importieren.',
    ...
    importDescription:
      'Schnipsel aus einem GitHub-Gist abrufen oder anhand von YAML-Code erstellen.',
    ...
    noRunInOutlook:
      'Das Code-Schnipsel kann in Outlook nicht aus dem Code-Fenster heraus ausgeführt werden. Bitte öffnen Sie den Aufgabenbereich zur Code-Ausführung und rufen Sie das Schnipsel von dort aus auf.',
    ...
    sharedGistsSignIn:
      'Melden Sie sich bei GitHub an, um eines Ihrer in dortigen Gists abgelegten Schnipsel abzurufen.',
    samplesDescription:
      'Wählen Sie eines der nachfolgenden Beispiele aus, um zu starten.',
    ...
    localStorageWarning:
      `Alle lokal gespeicherten Schnipsel werden gelöscht, wenn Sie Ihren Browser-Cache löschen. ` +
    ...
    Refresh: {
      ...
      getTextToAppendToErrorMessage: (returnUrl: string) =>
        returnUrl
          ? 'Zurück zu ...'
          : 'Schließen Sie dieses Fenster und versuchen Sie es nochmal.',
    },

    Runner: {
      snippetNoLongerExists:
        'Das Schnipsel ist nicht mehr verfügbar. Laden Sie diese Seite neu oder kehren Sie zu der vorherigen Seite zurück.',
      ...
      runtimeErrorWhileLoadingTheSnippet:
        'Beim Laden des Schnipsels ist ein Laufzeitfehler aufgetreten',
      goBackToEditorToFixError:
        'Wechseln Sie bitte zum Editor, um den Fehler zu beheben.',
    },
    ...
    HtmlPageStrings: {
      ...
      tutorialDescription:
        'Folgende Excel-Datei beinhaltet eine Anleitung, um Script Lab in',
      download: 'wenigen Schritten kennenzulernen:',
      errorInitializingScriptLab:
        'Es ist ein Fehler bei der Initialisierung von Script Lab aufgetreten.',
    },
    ...
    Auth: {
      ...
      invalidParametersPassedInForAuth:
        'Es wurden ungültige Parameter zur Authentifizierung übergeben',
      invalidAuthResponseReceived:
        'Der Authentifizierungsdienst hat eine ungültige Antwort zurückgeliefert',
