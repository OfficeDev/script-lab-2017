export function getEnglishStrings(): ClientStringsPerLanguage {
  ...
  return {
    ...
    failedToLoadCodeSnippet:
      /** NEEDS STRING REVIEW */ 'Failed to load the code snippet.',

    snippetGistIdDuplicationError:
      'There is an existing snippet that was imported from the same Gist ID. Do you want to switch to this snippet or create a new copy?',
    ...
    snippetOpenInPlaygroundError:
      /** NEEDS STRING REVIEW */ 'Failed to open in playground',
    ...
    snippetExportNotSupported:
      'Snippet export is not yet supported on this version of Office. Supported platforms include Windows and Office Online.',
    ...
    invalidExperimentationFlags:
      'Invalid experimentation flags (must be a valid JSON object)',
    ...
    sharePublicSnippetConfirm:
      /** NEEDS STRING REVIEW */ 'Are you sure you want to re-share this snippet as a brand new public gist?',
    sharePrivateSnippetConfirm:
      /** NEEDS STRING REVIEW */ 'Are you sure you want to re-share this snippet as a brand new secret gist?',
    ...
    getTextForCustomFunctionsLastUpdated: (
      ...
      return (
        'The currently-running custom functions code was last updated ' +
        lastUpdatesXSecondsAgo +
        '\n' +
        'The runner itself was alive as of ' +
    ...
    noSnippetsMessage:
      'You have no local snippets. You can create a new one, pick one of the samples, or import one from somewhere else.',
    ...
    Runner: {
      snippetNoLongerExists:
        'That snippet no longer exists. Reload this page, or return to the previous one.',
    ...
    HtmlPageStrings: {
      ...
      toGetStartedCreateOrImportSnippet:
        'To get started, create or import a snippet via the "Code" button.',
      ...
      tutorialDescription:
        'This Excel file shows you how to use Script Lab in a few easy steps:',
      download: 'Download',
    ...
    Auth: {
      ...
      invalidParametersPassedInForAuth:
        'Invalid parameters passed in for establishing app authentication',
