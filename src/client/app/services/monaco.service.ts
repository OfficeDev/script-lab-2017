...
export class MonacoService {
  ...
  private _loadLibrariesIntellisense = this._request
    .local<ILibraryDefinition[]>('libraries.json', ResponseTypes.JSON)
    .toPromise()
    .then(libraries =>
                ...
                items: {
                  ...
                  properties: {
                    ...
                    description: {
                      ...
                      default: '',
                      examples: ['Multiplies 10 to the input number'],
                    },
                    helpUrl: {
                    ...
                    result: {
                      ...
                      properties: {
                        type: {
                          $id:
                            '/properties/functions/items/properties/result/properties/type',
                          type: 'string',
                        ...
                        dimensionality: {
                          $id:
                            '/properties/functions/items/properties/result/properties/dimensionality',
                          type: 'string',
                    ...
                    parameters: {
                      ...
                      items: {
                        ...
                        properties: {
                          name: {
                            $id:
                              '/properties/functions/items/properties/parameters/items/properties/name',
                            type: 'string',
                            title: 'The Name Schema ',
                            default: '',
                            examples: ['num'],
                          ...
                          description: {
                            $id:
                              '/properties/functions/items/properties/parameters/items/properties/description',
                            type: 'string',
                            title: 'The Description Schema ',
                            default: '',
                            examples: ['The number to multiply to 10'],
                          },
                          type: {
                            $id:
                              '/properties/functions/items/properties/parameters/items/properties/type',
                            type: 'string',
                            title: 'The Type Schema ',
                            default: '',
                            examples: ['number'],
                          ...
                          dimensionality: {
                            $id:
                              '/properties/functions/items/properties/parameters/items/properties/dimensionality',
                            type: 'string',
                            title: 'The Dimensionality Schema ',
                            default: '',
                            examples: ['scalar'],
                    ...
                    options: {
                      ...
                      properties: {
                        sync: {
                          $id:
                            '/properties/functions/items/properties/options/properties/sync',
                          type: 'boolean',
                        ...
                        stream: {
                          $id:
                            '/properties/functions/items/properties/options/properties/stream',
                          type: 'boolean',
                        ...
                        volatile: {
                          $id:
                            '/properties/functions/items/properties/options/properties/volatile',
                          type: 'boolean',
