...
// ALSO VERY IMPORTANT:  If adding new environments, be sure to update
//    the list in "this.configs" in "about.ts",
//    and also "IEnvironmentConfig" and "IEnvironmentConfigsMap" in "playground.d.ts"
const config = {
  local: {
    name: 'LOCAL',
    clientId: '',
    ...
    samplesUrl:
      'https://raw.githubusercontent.com/OfficeDev/office-js-snippets/deploy-beta',
    feedbackUrl,
  ...
  staging: {
    ...
    samplesUrl:
      'https://raw.githubusercontent.com/OfficeDev/office-js-snippets/deploy-prod',
    feedbackUrl,
    thirdPartyAADAppClientId,
  },
  productiondirect: {
    // doesn't need to show up in "about" list or elsewhere, only for being able to quickly test the site before purging the CDN.
        ...
        (function() {
            try {
                ...
                function isAllowedUrl(url) {
                    ...
                    var validRedirectLocations = ${JSON.stringify(
                      validRedirectLocations
                    )};
